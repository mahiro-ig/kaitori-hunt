        ...
        <main className="prose prose-sm max-w-none md:prose-base dark:prose-invert">
          ...
          <section id="article-3" className="scroll-mt-20">
            ...
            <ol className="list-decimal pl-5 space-y-1">
              ...
              <li>個人事業主および法人が買取申請を行う場合は、<strong>適格請求書発行事業者登録番号（インボイス番号）の申告</strong>が必須です。番号を保有しない場合は買取できません。</li>
            </ol>
          </section>
          ...
          <section id="article-9" className="scroll-mt-20">
            ...
            <p>
              当社は、利用者が本規約に違反した場合、登録情報が虚偽である場合、不正取得品や模造品等の持込みが判明した場合、支払遅延その他の債務不履行がある場合、または連絡不能となった場合には、事前通知なくサービス提供を停止することができます。
            </p>
          </section>
          ...
          <section id="article-10" className="scroll-mt-20">
            ...
            <ol className="list-decimal pl-5 space-y-1">
              <li>当社は、買取申込受付後であっても、次のいずれかの事由により、当社が買取申込受付時に提示した条件で本サービスを継続すること、または買取代金の支払いが著しく困難となり、もしくはそのおそれがある場合には、利用者に通知の上、当該買取申込を取消し、対象商品を返送することができるものとします。</li>
              <li>
                前項に定める事由は次のとおりです。
                <ul className="list-disc pl-5 mt-1">
                  <li>戦争、テロ、暴動その他これらに類する事態</li>
                  <li>天災地変または感染症の流行</li>
          ...
          <section id="article-12" className="scroll-mt-20">
