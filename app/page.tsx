...
// import { Header } from "@/components/header"; // ← 削除
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">ニュース</h2>
...
export default function Home() {
  ...
  // ★ 修正版：非表示バリアントを除外するパラメータを追加
  const onSubmitSearch = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const params = new URLSearchParams();
    if (keyword.trim()) params.set("q", keyword.trim());
    if (category) params.set("category", category);
    // 表示中のバリアントのみを対象にするフラグを追加
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Header は layout 経由で出てるのでここでは描画しない */}
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">買取カテゴリー</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  専門スタッフが丁寧に査定し、市場価値に基づいた適正価格で買取いたします。
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto mt-8 grid grid-cols-1 gap-6 md:grid-cols-3 max-w-6xl">
              ...
              <Link href="/categories/camera" className="group relative overflow-hidden rounded-lg border p-6 hover:border-primary">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <p className="text-muted-foreground text-center">
                    一眼レフ、ミラーレス、コンパクトカメラなど、新品未使用品を買取しています。
                  </p>
                  <Button variant="outline" className="mt-2 group-hover:bg-primary group-hover:text-primary-foreground">
                    詳細を見る
                  </Button>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">買取の流れ</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  簡単3ステップで、あなたの製品を高価買取いたします。
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto mt-8 grid grid-cols-1 gap-6 md:grid-cols-3 max-w-6xl">
              ...
              <div className="flex flex-col items-center space-y-4 rounded-lg border bg-background p-6">
                ...
                <h3 className="text-xl font-bold">郵送・査定・買取成立</h3>
                <p className="text-muted-foreground text-center">
                  製品を郵送もしくは店舗にお持ち込みいただき、専門スタッフが査定。買取金額にご納得いただければ買取成立です。
                </p>
              </div>
            </div>
